        ...
        <div
          ...
          >
            ...
            <div className="flex space-x-1 items-center ">
              <button className="bg-green-400 w-24 text-2xl" onClick={()=>{onDone(index)
                console.log(index)}}>Done</button>
              <button className="bg-red-400 w-24 text-2xl" onClick={()=>onDelete(index)}>Delete</button>
            </div>
          </div>
    );
}
